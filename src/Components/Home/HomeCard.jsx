...
const HomeCard = ({ product, onPreviewClick, addToCart }) => {
  const { image, productIntro, price, roundoffPrice, sale, shippingPrice,shippingFee } = product;

  return (
    <div className="card border-[1px] rounded-2xl p-1 bg-white flex flex-col">
      <div className="imgDiv w-[100%] rounded-2xl flex-1">
        <img className='w-full rounded-2xl' src={image} alt="home-card-img" />
      </div>
