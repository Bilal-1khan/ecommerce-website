              ...
              {cart.length > 0 ? (
                <div className="grid grid-cols-1 gap-4">
                  {cart.map((product, index) => (
                    <div
                      key={index}
                      className="cart-item border p-4 rounded flex items-center"
                    >
                      <img
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center mt-2">
                          ...
                          <span>{countQty}</span>
                          <button
                            className="ml-2 px-3 py-1 bg-gray-200"
                      ...
                      <div>
                        <div className="border-gray-200 border w-[200px] px-2 py-4 rounded-lg">
                          ...
                          <p className="font-bold">
                            Total price :{" "}
                            {product.price * countQty + product.shippingFee}
                          </p>
                          <Link to="/checkout">
                            <button className="mt-4 text-white w-full  py-2 text-xl bg-red-500 rounded-xl">
                              Check out
                            </button>
                          </Link>
                        </div>
